...
import com.example.demoroomdb.view.MainActivity;
...
public class ReceiveMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (!remoteMessage.getNotification().toString().isEmpty()) {
            Log.d(TAG,"Message data payload: " + remoteMessage.getNotification());
            sendNotification(remoteMessage.getNotification().getBody());
        }
    }

    private void sendNotification(String messagingBody) {
